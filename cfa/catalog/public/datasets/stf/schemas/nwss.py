...
load_schema = pa.DataFrameSchema(
    {
        ...
        "wwtp_jurisdiction": pa.Column(
            str, pa.Check.isin(wwtop_opts), nullable=True
        ),
        "county_names": pa.Column(str, nullable=True),
        "stormwater_input": pa.Column(
            str, pa.Check.isin(["yes", "no"]), nullable=True
        ),
        "influent_equilibrated": pa.Column(
            str, pa.Check.isin(["yes", "no", "0"]), nullable=True
        ),
        "sample_type": pa.Column(str, nullable=True),
        "sample_matrix": pa.Column(
            str, pa.Check.isin(matrix_opts), nullable=True
        ),
        "sample_location": pa.Column(
            str, pa.Check.isin(sample_location_opts), nullable=True
        ),
        "sample_location_specify": pa.Column(
            object, nullable=True, coerce=True
        ),
        "reporting_jurisdiction": pa.Column(
            str, pa.Check.isin(reporting_jur_opts), nullable=True
        ),
        "capacity_mgd": pa.Column(float, nullable=True),
        "population_served": pa.Column(
            str, pa.Check.isin(["yes", "no"]), nullable=True, coerce=True
        ),
...
def load_mock_data(output="pandas", size=10) -> pd.DataFrame | pl.DataFrame:
    data = {
        ...
        "cases_new_cens_per100k": [
            random.uniform(0, 11200) for _ in range(size)
        ],
        "pcr_target_flowpop_lin": [
            random.uniform(5, 4e18) for _ in range(size)
        ],
        "sample_collect_date": [fake.date() for _ in range(size)],
        "pcr_target_flowpop_log10": [
            random.uniform(1.1, 18) for _ in range(size)
        ],
        ...
        "county_names": [
            f"{random.randint(0, 99999):05d}" for _ in range(size)
        ],
        "stormwater_input": [
        ...
        "sample_location": [
            random.choice(sample_location_opts) for _ in range(size)
        ],
        "sample_location_specify": [
            random.uniform(2, 724) for _ in range(size)
        ],
        "reporting_jurisdiction": [
            random.choice(reporting_jur_opts) for _ in range(size)
        ],
        ...
        "predsuprexc_flowpop_5m": [
            random.uniform(-19, 129) for _ in range(size)
        ],
        "alert_flowpop_5m": [
            random.choice(["yes", "no"]) for _ in range(size)
        ],
        ...
        "pcr_target_flowpop_lin_roll7": [
            random.uniform(0, 1) for _ in range(size)
        ],
        "pcr_target_flowpop_lin_spline": [
            random.uniform(0, 1) for _ in range(size)
        ],
        "pcr_target_mic_lin_spline": [
            random.uniform(0, 1) for _ in range(size)
        ],
        ...
        "quant_stan_type": [
            random.choice(["type1", "type2"]) for _ in range(size)
        ],
        "pcr_target_units": [
